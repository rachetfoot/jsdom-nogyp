var fs = require('./jsdom/fs');
var path = require('./jsdom/path');
var URL = require('./jsdom/url');
var pkg = require('../package.json');

var utils = require('./jsdom/utils');
var toFileUrl = utils.toFileUrl;
...
exports.setTimeout = utils.setTimeout;
exports.clearTimeout = utils.clearTimeout;
...
exports.env = exports.jsdom.env = function () {
  ...
  function handleUrl() {
	...
	config.html = "<html><head></head><body>We can't follow urls!</body></html>";
	processHTML(config);
  }
};
